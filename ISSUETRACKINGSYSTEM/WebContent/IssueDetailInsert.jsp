...
function insert()
{
	alert("insert...");
		...
		f.action="IssueDetailInsertServlet";
		f.submit();
}
function ins()
{
...
<body>
	<form action="IssueDetailInsertServlet" name="frm" method="post"
		...
		<div class="main-content">
				...
				<table border="2" align="center">
					<tr>
						...
						<td><input type="text" name="issuetitle" id="issuetitle"
							title="give the title of issue"></td>
					</tr>

					<tr>
						<td>ISSUE DESCRIPTION</td>
						<td><input type="text" name="issuedescription"
							id="issuedescription" title="give the issue descrpition"></td>
					</tr>
			...
			yearStart:2007
							...
							value="" title="Select date when issue created" /></td>
					</tr>
					<tr>
						<td>Project::</td>
...
%>
			...
			%>
					...
					<tr>
						<td>Snap Shot</td>
						<td><input type="file" name="issueimage" id="issueimage">
						</td>
					</tr>


					<tr>
						<td><input type="submit" name="btnAdd" id="btnAdd"
							value="Add"></td>
					</tr>
					<tr>
						<td><a href="#" onclick="sel()">List page</a></td>
					</tr>
					<tr>
						<script>

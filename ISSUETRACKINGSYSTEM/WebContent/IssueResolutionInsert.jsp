...
{
var f=document.frm;
f.action="IssueResolutionInsertServlet";
f.submit();
}
</script>
</head>
...
%>
					...
					<tr>
						...
						<td><input type="text" name="actionType" id="actionType"></td>
					</tr>
					<tr>
						<td>Issue Action Description</td>
						<td><textarea rows="2" cols="3" name="actionDescription"></textarea>
						</td>
					</tr>
					<tr>
						<td>Issue Resolved By::</td>
						<td><select name="issueresolvedBy">
...
%>
					...
					<tr>
						...
						<td><input type="text" name="issueResolvedDate"
							class="slimpicker"
							alt="{
			dayChars:3,
